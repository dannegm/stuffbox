...
function ControlGroup({ children }) {
    return (
        <div className='border-border bg-background [&>button:not(:last-child)]:border-border flex flex-col overflow-hidden rounded-lg border shadow-md shadow-black/10 [&>button:not(:last-child)]:border-b'>
            {children}
        </div>
    );
}
